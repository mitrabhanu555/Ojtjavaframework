...
public class ExcelFileUtil {
	...
	public ExcelFileUtil() throws Throwable{
		...
		FileInputStream fi = new FileInputStream("D:\\Selenium-Evening\\ERP_Stock\\TestInput\\InputSheet.xlsx");
...
public void setCellData(String sheetname,int row,int column,String status) throws Throwable{
	...
	FileOutputStream fo = new FileOutputStream("D:\\Selenium-Evening\\ERP_Stock\\TestOutput\\hybrid.xlsx");
	wb.write(fo);
	fo.close();
